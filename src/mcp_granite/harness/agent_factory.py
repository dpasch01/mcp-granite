...
from mcp_granite.models.registry import get_adk_model
...
def _resolve_server_module(domain: str, granularity: str) -> str:
    ...
    Convention: mcp_granite.mcp_servers.{domain}.{granularity}_server
    """
    module_path = f"mcp_granite.mcp_servers.{domain}.{granularity}_server"
    try:
